                ...
                for c2 in range(3):
                    for q1 in range(2):
                        for q2 in range(2):
                            for a1 in range(10):
                                for a2 in range(10):
                                    crosswise_similarity[i, c1, k, c2, q1, q2, a1, a2] = (
                                        (
                                            locations[i, c1, q1, a1] * points[i, c2, k, q2, a2]
                                        ).sum()
                                    )
    return crosswise_similarity.reshape(2, 3, 2, 3, 4, 10, 10)


def explicit_pairwise(
    points
):
                    ...
                    for k2 in range(2):
                        for q1 in range(2):
                            for q2 in range(2):
                                for a1 in range(10):
                                    for a2 in range(10):
                                        pairwise_similarity[i, c1, k1, c2, k2, q1, q2, a1, a2] = (
                                            (
                                                points[i, c1, k1, q1, a1] * points[i, c2, k2, q2, a2]
                                            ).sum()
                                        )
