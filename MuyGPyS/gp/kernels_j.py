...
class RBF(KernelFn):
    ...
    def __call__(self, squared_dists: jnp.ndarray) -> jnp.ndarray:
        """
    ...
    @staticmethod
    @jit
    def _fn(squared_dists: jnp.ndarray, length_scale: float) -> jnp.ndarray:
...
class Matern(KernelFn):
    ...
    def __call__(self, dists: jnp.ndarray) -> jnp.ndarray:
        """
